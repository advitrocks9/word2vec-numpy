...
To demonstrate low-level ML engineering fluency: understanding the math, implementing the gradients from scratch, proving correctness via numerical verification, and writing clean, type-annotated, production-style Python.
...
*Loss curve will be added after training completes.*
...
*t-SNE plot will be added after training completes.*

### Nearest Neighbors

| Query | Top-5 Neighbors |
|-------|-----------------|
| king | queen, prince, emperor, throne, monarchy |
| france | germany, italy, spain, belgium, britain |
| computer | computers, software, hardware, digital, computing |
| good | great, better, well, fine, excellent |
| river | rivers, creek, lake, tributary, waterway |

*Placeholder — actual results will be updated after training.*
...
|-----------|-------|---------------|
| Embedding dim *d* | 200 | Good balance of quality vs. memory |
| Window size | 5 | Mikolov's default |
| Negative samples *K* | 5 | Sufficient for ~17 M words |
...
│   └── model.py           # SGNSModel: forward, backward, update, gradient_check
